...
# # Функция для получения сообщений (эмуляция запроса от бота)
# def get_messages():
#     # Здесь можно подключить API или базу данных, где хранятся сообщения
#     return [
...
#             messages_list.controls.append(ft.Text(f"{msg['user']}: {msg['message']}"))
#         page.update()
